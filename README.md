...
- [Modern Large Language Model Architectures \& Distributed Systems: The Complete Technical Compendium](#modern-large-language-model-architectures--distributed-systems-the-complete-technical-compendium)
  ...
  - [2. Module I: Numerical Precision, Arithmetic \& Model Quantization](#2-module-i-numerical-precision-arithmetic--model-quantization)
    ...
    - [2.7 Sub-2-Bit and Extreme Low-Bit Paradigms](#27-sub-2-bit-and-extreme-low-bit-paradigms)
      ...
      - [2.7.2 BitNet 1.58b (Ternary Quantization $\{-1, 0, +1\}$)](#272-bitnet-158b-ternary-quantization--1-0-1)
  ...
  - [4. Module III: Distributed Training, Memory Layouts \& Systems Parallelism](#4-module-iii-distributed-training-memory-layouts--systems-parallelism)
    - [4.1 Anatomy of GPU Memory in Large Language Models](#41-anatomy-of-gpu-memory-in-large-language-models)
      - [4.1.1 The 16 Bytes/Parameter Rule in Mixed-Precision Adam](#411-the-16-bytesparameter-rule-in-mixed-precision-adam)
  ...
  - [5. Module IV: LLM Inference Economics, Memory Architecture \& PagedAttention](#5-module-iv-llm-inference-economics-memory-architecture--pagedattention)
    ...
    - [5.4 The KV Cache: Eliminating Redundant $O(L^2)$ Attention](#54-the-kv-cache-eliminating-redundant-ol2-attention)
  ...
  - [6. Module V: Novel Transformer Topologies — Per-Layer Embeddings (PLE) in Gemma 4](#6-module-v-novel-transformer-topologies--per-layer-embeddings-ple-in-gemma-4)
    ...
    - [6.3 Deep Dive: Why the Hadamard Product ($\odot$) Is Structurally Mandatory](#63-deep-dive-why-the-hadamard-product-odot-is-structurally-mandatory)
...
#### 2.7.2 BitNet 1.58b (Ternary Quantization $\{-1, 0, +1\}$)
...
#### 4.1.1 The 16 Bytes/Parameter Rule in Mixed-Precision Adam
...
### 5.4 The KV Cache: Eliminating Redundant $O(L^2)$ Attention
...
### 6.3 Deep Dive: Why the Hadamard Product ($\odot$) Is Structurally Mandatory
